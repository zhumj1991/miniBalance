...
#define	MOTORS_DIR_GPIO_PERIF			RCC_AHB1Periph_GPIOB
#define MOTORS_DIR_GPIO_PORT      GPIOB
#define	MOTORS_DIR_GPIO_AIN1			GPIO_Pin_12
#define	MOTORS_DIR_GPIO_AIN2			GPIO_Pin_13
#define	MOTORS_DIR_GPIO_BIN1			GPIO_Pin_14
#define	MOTORS_DIR_GPIO_BIN2			GPIO_Pin_15

#define	MOTORS_STBY_GPIO_PERIF		RCC_AHB1Periph_GPIOA
#define MOTORS_STBY_GPIO_PORT     GPIOA
#define	MOTORS_STBY_GPIO					GPIO_Pin_0
...
void motorsInit(void)
{
  ...
  RCC_AHB1PeriphClockCmd(MOTORS_GPIO_PERIF | MOTORS_DIR_GPIO_PERIF | RCC_AHB1Periph_GPIOA, ENABLE);
