...
//#define NRF_UART
  ...
  #define UART_GPIO_AF_TX_PIN   GPIO_PinSource9
  #define UART_GPIO_AF_RX_PIN   GPIO_PinSource10
  #define UART_GPIO_AF_TX       GPIO_AF_USART1
  #define UART_GPIO_AF_RX       GPIO_AF_USART1
#endif
