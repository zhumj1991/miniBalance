...
#define PM_GPIO_SYSOFF_PERIF    RCC_AHB1Periph_GPIOB
#define PM_GPIO_SYSOFF_PORT     GPIOB
#define PM_GPIO_SYSOFF          GPIO_Pin_13

#define PM_GPIO_EN1_PERIF       RCC_AHB1Periph_GPIOC
#define PM_GPIO_EN1_PORT        GPIOC
#define PM_GPIO_EN1             GPIO_Pin_8

#define PM_GPIO_EN2_PERIF       RCC_AHB1Periph_GPIOC
#define PM_GPIO_EN2_PORT        GPIOC
#define PM_GPIO_EN2             GPIO_Pin_9

#define PM_GPIO_IN_CHG_PERIF    RCC_AHB1Periph_GPIOC
#define PM_GPIO_IN_CHG_PORT     GPIOC
#define PM_GPIO_IN_CHG          GPIO_Pin_6

#define PM_GPIO_IN_PGOOD_PERIF  RCC_AHB1Periph_GPIOC
#define PM_GPIO_IN_PGOOD_PORT   GPIOC
#define PM_GPIO_IN_PGOOD        GPIO_Pin_7

// Power managment pins
#define PM_GPIO_BAT_PERIF       RCC_AHB1Periph_GPIOC
